...
let res44 = str44.match(/[^\^\@][a-zA-Z]{2}/g);
console.log(res44);
...
// 52. Определите, начинается ли переданная строка с 'http://'.
let res52 = /^http:/.test("http://");
console.log(res52);

// 53. Определите, начинается ли переданная строка с 'http://' или с 'https://'.
let res53 = /^http:||https:/.test("http://");
console.log(res53);

// 54. Определите, что ли заканчивается переданная строка расширением 'txt', 'html' или 'php'.
let res54 = /(txt|html|php)$/.test("54txt");
console.log(res54);

// 55. Определите, что ли заканчивается переданная строка расширением 'jpg' или 'jpeg'.
let res55 = /(jpg|jpeg)$/.test("12.jpg");
console.log(res55);

// 56. Определите, является ли строка 'числом, длиной от 1 до 12 цифр'.
let res56 = /\d{12}/.test("1234567891011");
console.log(res56);

// 57. Определите, является ли переданная строка датой в формате день-год-месяц.
let res57 = /\d{1,2}-\d{1,2}-\d{4}/.test("25-03-1999");
console.log(res57);

// 58. Определите, является ли переданная строка датой в формате день.месяц.год.
let res58 = /\d{1,2}\.\d{1,2}\.\d{4}/.test("1.1.1992");
console.log(res58);

// 59. Определите, является ли переданная строка временем в формате часы:минуты:секунды.
let res59 = /\d{1,2}:\d{1,2}:\d{1,2}/.test("00:36:59");
console.log(res59);
...
let str64 = "1 23 456 789";
let res64 = str64.search(/\d{3}/g);
console.log(res64);

// ********************  Метод split в регулярных выражениях    *******************************************

// 65. Дана строка с датой и временем:
...
let str65 = "2025-12-31 12:59:59";
let res65 = str65.split(/[-:\s]/);
console.log(res65);
